...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        # Tool Bar
        self.main_frame_toolbar = wx.ToolBar(self, -1, style=wx.TB_HORIZONTAL|wx.TB_DOCKABLE|wx.TB_TEXT|wx.TB_NOICONS)
        self.SetToolBar(self.main_frame_toolbar)
        self.main_frame_toolbar.AddLabelTool(1004, _("First"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.main_frame_toolbar.AddLabelTool(1003, _("Previous"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.main_frame_toolbar.AddLabelTool(1004, _("Next"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.main_frame_toolbar.AddLabelTool(1005, _("Last"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.main_frame_toolbar.AddSeparator()
        self.main_frame_toolbar.AddLabelTool(1006, _("Add"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, _("Add a new film"), _("Add a new film to the collection"))
        self.main_frame_toolbar.AddLabelTool(1008, _("Delete"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, _("Delete this film"), _("Deletes this film from collection"))
        self.main_frame_toolbar.AddLabelTool(1009, _("Edit"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, _("Edit film details"), _("Edit film details"))
        self.main_frame_toolbar.AddSeparator()
        self.main_frame_toolbar.AddLabelTool(1010, _("Webpage"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, _("Go to the film webpage"), _("Go to the film webpage"))
        self.main_frame_toolbar.AddSeparator()
        self.main_frame_toolbar.AddLabelTool(1011, _("Add Local Poster"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, _("Add poster from file"), _("Open a local image file and use it as a poster"))
        self.main_frame_toolbar.AddLabelTool(1012, _("Remove Poster"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, _("Remove poster"), _("Remove poster"))
        self.main_frame_toolbar.AddLabelTool(1013, _("Amazon Poster"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, _("Add Poster From Amazon"), _("Try to find a poster using the Amazon Services on the web"))
        # Tool Bar end
        ...
        self.Bind(wx.EVT_TOOL, self.OnAddLocalPoster, id=1011)
        self.Bind(wx.EVT_TOOL, self.OnRemovePoster, id=1012)
