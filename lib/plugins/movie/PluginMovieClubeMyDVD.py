...
__revision__ = '$Id: PluginMovieClubeMyDVD.py,v 1.4 2005/09/26 23:02:31 iznogoud Exp $'
...
class Plugin(movie.Movie):
    ...
    def __init__(self, id):
        ...
        self.movie_id = id
        self.url = "http://www.clubemydvd.com/film.php?id=" \
            + str(self.movie_id)
    ...
    def plot(self):
        ...
        self.plot = gutils.trim(self.page, "<b>Sinopse:</b> ", \
            "</td>")
        
    def year(self):
        """Finds the film's year"""
        self.year = gutils.trim(self.page, "<b>Ano:</b> ", \
            "</td>")
    ...
    def imdb(self):
        ...
        self.imdb = gutils.trim(self.page, \
            "Site Oficial</a> <a class=\"botao\" href=\"", \
            "\" title=")
    ...
    def notes(self):
        ...
        self.notes = "Video: " + gutils.trim(self.page, "<b>Video:</b> ", \
            "</td>")
        self.notes += "\nAudio: " + gutils.trim(self.page, "<b>Audio:</b> ", \
            "</td>")
        self.notes += "\nLegendas: " + gutils.trim(self.page, "<b>Legendas:</b> ", \
            "</td>")
...
class SearchPlugin(movie.SearchMovie):
    ...
    def sub_search(self):
        ...
        self.page = gutils.trim(self.page, \
            "Foram encontrados ", "<b>Dica:</b>")
        
    def get_searches(self):
        """Try to find both id and film title for each search result"""
        self.elements = string.split(self.page, """<td>&nbsp;""")
