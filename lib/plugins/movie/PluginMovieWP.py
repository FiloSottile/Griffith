...
class Plugin(movie.Movie):
	...
	def get_o_title(self):
		self.o_title = gutils.trim(self.page, '<b>Tytuł oryginału:</b>', "\t\t</div><div")

	def get_title(self):
		self.title = gutils.trim(self.page, '<b>Tytuł polski:</b>', "\t\t</div><div")

	def get_director(self):
		self.director = gutils.trim(self.cast_page, '>reżyser	</div>', '</div>')
	...
	def get_classification(self):
		self.classification = gutils.trim(self.page, '<b>Przedział wiekowy:</b>', "\t\t</div><div")
