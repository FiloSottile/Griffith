...
class Plugin(movie.Movie):
    ...
    def genre(self):
        self.genre = gutils.trim(self.page,"<a href=\"/Sections/Genres/","</a>")
    ...
    def imdb(self):
        self.imdb = "http://www.imdb.com/title/tt" + self.movie_id;
        
    def trailer(self):
        self.trailer = "http://www.imdb.com/title/tt" + self.movie_id + "/trailers"
